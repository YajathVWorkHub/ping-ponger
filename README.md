...
- [yes] All 4 tasks completed
- [yes] Game behaves as expected
- [yes] No bugs or crashes
- [yes] Code reviewed with LLM
- [yes] Final score and winner display works correctly
- [yes] Score appears correctly on both player and AI sides
- [yes] Dependencies listed in `requirements.txt`
- [yes] README is followed during setup and testing
- [yes] Codebase is clean, modular, and understandable
- [yes] Submission should include the Chat/LLM used Page link with the complete chat history.
